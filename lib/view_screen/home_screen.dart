    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              RadioListTile(value: "BJP", groupValue: aji, onChanged: (rv){
                setState(() {
                  aji=rv as String;
                });
              },
              ...
              RadioListTile(value: "CONG", groupValue: aji, onChanged: (rv){
                setState(() {
                  aji=rv as String;
                });
              },
              ...
              RadioListTile(value: "APP", groupValue: aji, onChanged: (rv){
                setState(() {
                  aji=rv as String;
                });
              },
